...
static uint16_t __attribute__((section(".sram_d2"))) __attribute__((aligned(64))) frame_buffer[2][HW_LCD_WIDTH * HW_LCD_HEIGHT];
static uint16_t __attribute__((section(".sram_d2"))) __attribute__((aligned(64))) lcd_buffer[HW_LCD_WIDTH * HW_LCD_HEIGHT];
